...
//                    }
            ...
            case TYPE_OFFICER_TITLE:
                ...
                if(map9.containsKey("officer_size")){
                    ...
                    //大于三位员工的时候可以查看列表
                    if(size>0){
                        holder.imageViewofficer.setVisibility(View.VISIBLE);
        ...
        public MainViewHolder(View root, int viewtype) {
            ...
            switch (viewtype) {
                ...
                case 8:
                    ...
                    imageView= (ImageView) root.findViewById(R.id.stoer_lay_project_title_Img);
                    break;
                ...
                case 9:
                    ...
                    imageViewofficer= (ImageView) root.findViewById(R.id.store_lay_office_title_Img);
                    break;
