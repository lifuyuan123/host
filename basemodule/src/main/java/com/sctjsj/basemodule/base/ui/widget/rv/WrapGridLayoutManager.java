package com.sctjsj.basemodule.base.ui.widget.rv;
...
public class WrapGridLayoutManager extends GridLayoutManager {
    ...
    public WrapGridLayoutManager(Context context, int spanCount, int orientation, boolean reverseLayout, int[] mMeasuredDimension) {
